...
#if defined (CONFIG_MACH_M7_UL) || defined (CONFIG_MACH_M7_WLJ) || defined (CONFIG_MACH_M7_WLS) || defined(CONFIG_MACH_M7_WLV) || defined(CONFIG_MACH_M7_DCG) || defined(CONFIG_MACH_M7_DUG) || defined(CONFIG_MACH_M7_DTU)
	INT_KEY_HP,
#endif
};
